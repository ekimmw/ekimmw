...
- **Position:** Senior Cyber Security / Back-End  
- **Experience:** ~4 years in cybersecurity, system automation, and server administration  
- **Coding & Exploits:** Bash scripting, tool/script development, exploit writing, API design & implementation  
- **Platforms:** Ability to develop applications for Desktop, Mobile, and Servers from scratch  
- **Physical Hacking:** ESP3866, ESP0938, WiFi Pineapple, Flipper Zero, OMG and similar hardware-level security devices  
- **CTF & Bug Bounty:** Active participation — finding vulnerabilities and responsible disclosure  
- **Databases:** SQLite, MongoDB, and other lightweight NoSQL systems  
...
> **Note:** All tools are used for ethical security research, authorized penetration testing, and defensive security improvement.
...
**Phone & Computer Repair**, custom software development, and **GSM services**.  
